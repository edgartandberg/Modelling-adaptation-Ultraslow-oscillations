function [v_e, t_e, e_counter, m, h, n, spiketimes_e, w_e,i_ext_e_all] = excitatory_HH_adaptation(t_final,dt,i_ext_e,t_k,b_k)
...
% for k=1:m_steps
% 
%     i_ext_e = 20.0; % in micro A
%     %i_ext_e = i_ext_e + 1*randn;
% 
