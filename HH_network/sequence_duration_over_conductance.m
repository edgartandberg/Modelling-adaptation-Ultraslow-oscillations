...
start_conductance=0.15;
end_conductance = 0.25;
step_size = 0.01;
...
avgLine = plot(conductance_array, averages, 'k-', 'LineWidth', 2, 'DisplayName', 'Mean sequence duration');
...
legend(avgLine); % This will display the legend with 'Averages'
