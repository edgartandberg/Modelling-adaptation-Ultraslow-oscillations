function [spike_times_e, spike_times_i] = rasterPlot_HH(spike_times_e, spike_times_i, current_length)
...
% spike_times_e = cell(size(spiketrains_e_all,1),1);
% spike_times_i = cell(size(spiketrains_i_all,1),1);
% 
% % Function to detect spikes
...
% for neuron = 1:size(spiketrains_e_all,1)
...
% plots the raster for excitatory neurons
